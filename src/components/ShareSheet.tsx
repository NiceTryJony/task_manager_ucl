        ...
        <div className="flex-1 scrollable px-4 py-4 space-y-5">
          ...
          {showDebug && (
            <div className="bg-[#0a0a14] border border-amber/20 rounded-2xl p-3 space-y-1">
              ...
              <div className="pt-2 border-t border-bg-border/40 space-y-1">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5">
                          ...
                          {isMe && (
                            <span className="text-[10px] text-accent font-semibold px-1.5 py-0.5 bg-accent/15 rounded-full flex-shrink-0">you</span>
                          )}
                        </div>
                        {m.users.username && (
                      ...
                      <div className="relative flex-shrink-0">
                        {!isOwn && myRole === 'owner' ? (
                          <button
                            ...
                            className={cn('flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs font-semibold transition-all hover:opacity-80 active:scale-95', cfg.color, cfg.bg)}
                          >
                      ...
                      {!isOwn && !isMe && myRole === 'owner' && (
                        <button onClick={() => handleRemove(m.user_id, m.users.first_name)} disabled={removingId === m.user_id}
            ...
            <>
              ...
              <div className="space-y-3">
                <div className="relative">
                  ...
                  />
                  {query && (
                    <button onClick={clearSelection} className="absolute right-3 top-1/2 -translate-y-1/2 text-text-dim hover:text-text-secondary z-10">
                      <X size={14} />
                    </button>
                  )}
                </div>
